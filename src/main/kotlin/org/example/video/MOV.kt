    ...
    override fun convertTo(outputFilePath: String, ffmpegExecutablePath: String): ConversionResult {
        ...
        when (targetExtension) {
            ...
            "m4a" -> {
                ...
                System.err.println("No specific codecs defined for .$targetExtension when converting from MOV. Attempting default conversion.")
            }
        }

        command.add(outputFilePath)

        println("Converting $inputFilePath to $outputFilePath using custom MOV command: ${command.joinToString(" ")}")
